...
internal sealed class HandlerByUseCase //: IRequestHandler<Command, Empty>
{
    private readonly IOrderRepository orderRepository;
    private readonly IBuildOrderService buildOrderService;
    private readonly GetCommodity.IUseCase getCommodityUseCase;
    private readonly IDomainEventPublisher eventPublisher;
    private readonly IIntegrationEventBus integrationEventBus;

    public HandlerByUseCase(
        IOrderRepository orderRepository,
        IBuildOrderService buildOrderService,
        GetCommodity.IUseCase getCommodityUseCase,
        IDomainEventPublisher eventPublisher,
        IIntegrationEventBus integrationEventBus)
    {
        this.orderRepository = orderRepository;
        this.buildOrderService = buildOrderService;
        this.getCommodityUseCase = getCommodityUseCase;
