...
{
    public static void RegisterSelfTransientServices(this IServiceCollection services)
    {
        services.RegisterSelfTransientServices(Assembly.GetCallingAssembly());
    }

    public static void RegisterSelfTransientServices(
