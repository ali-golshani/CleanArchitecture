...
namespace Framework.Results.Resources {
    ...
    internal class ErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to {0} با شناسه درخواستی وجود دارد.
        /// </summary>
        internal static string Duplicate_1 {
            get {
                return ResourceManager.GetString("Duplicate_1", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0} با شناسه {1} وجود دارد.
        /// </summary>
        internal static string Duplicate_2 {
            get {
                return ResourceManager.GetString("Duplicate_2", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string NotFound_1 {
            get {
                return ResourceManager.GetString("NotFound_1", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0} با شناسه {1} یافت نشد.
        /// </summary>
        internal static string NotFound_2 {
            get {
                return ResourceManager.GetString("NotFound_2", resourceCulture);
            }
        }
